...
namespace Locadora_EAuditoria.Controllers
{
    ...
    {
        private readonly IService<LocacaoDTO> _repository;
        public LocacaoController(IService<LocacaoDTO> repository)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] LocacaoDTO request)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody] LocacaoDTO request)
        {
            try
            {
